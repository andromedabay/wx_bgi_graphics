...
add_custom_target(wx_bgi_headers_package
    ...
    COMMAND ${CMAKE_COMMAND} -DROOT_SOURCE_DIR=${CMAKE_SOURCE_DIR} -DHEADER_STAGING_DIR=${WXBGI_HEADER_STAGING_DIR} -P ${CMAKE_SOURCE_DIR}/cmake_files/08-zz01-StageHeaders.cmake
